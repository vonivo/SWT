...
def inside_parentheses(driver, element):
    ...
    return driver.execute_script("""
        ...
        var openBefore = (textBefore.match(/\(/g) || []).length;
        var closeBefore = (textBefore.match(/\)/g) || []).length;
        var openAfter = (textAfter.match(/\(/g) || []).length;
        var closeAfter = (textAfter.match(/\)/g) || []).length;
...
starting_page = input("Start-Seite:")
